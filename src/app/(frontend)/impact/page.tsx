...
import { FALLBACK_PUBLICATIONS, FALLBACK_DATASETS, FALLBACK_DISTRICTS } from "@/lib/data";
...
export default async function ImpactPage() {
  const [publicationsRaw, datasetsRaw, districtsRaw] = await Promise.all([
    prisma.publication.findMany({ include: { authors: { include: { author: true } }, researchVertical: true } }),
    prisma.biharDataset.findMany(),
    prisma.districtFactsheet.findMany()
  ]);
