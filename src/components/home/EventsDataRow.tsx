        ...
        <div className="flex flex-col gap-3">
          {displayEvents.length === 0 ? (
            <div className="flex flex-col items-center justify-center gap-2 py-8 text-center">
              ...
              <p className="text-[11px] text-muted">Upcoming events will be announced soon.</p>
            </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
          {displayDatasets.length === 0 ? (
            <div className="col-span-2 flex flex-col items-center justify-center gap-2 py-10 text-center">
              ...
              <p className="text-[11px] text-muted">Datasets will be available soon in the <Link href="/bihar" className="text-brand-primary hover:underline">Bihar Observatory</Link>.</p>
            </div>
